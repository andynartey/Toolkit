 ...
 * Build: http://modernizr.com/download/#-svg-load-cssclasses
 */
...
define('dropdown',["jquery"], function (jQuery) {
...
define('bootstrap-select',["jquery"], function (jQuery) {
...
define('tab',["jquery"], function (jQuery) {
...
define('transition',["jquery"], function (jQuery) {
...
define('collapse',["jquery"], function (jQuery) {
...
define('accordion',['require','jquery','transition','collapse'],function (require) {
...
define('dropdown-nav',['require','jquery'],function (require) {
...
define('tooltip',["jquery"], function (jQuery) {
...
define('popover',["jquery"], function (jQuery) {
...
define('popovers',['require','jquery','tooltip','popover'],function (require) {
    ...
    // Hiding popovers
    $('.tooltip, .popover-content').on('shown.bs.popover', function () {
        $('body').on('click', hidePopover);
    });

    $('.tooltip, .popover-content').on('hidden.bs.popover', function () {
...
define("visibilityjs", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Visibility;
    };
}(this)));
...
define('slideshow',['jquery', 'visibilityjs'], function (jQuery, Visibility) {
...
define('toolkit',['require','jquery','modernizr','dropdown','bootstrap-select','tab','accordion','dropdown-nav','popovers','slideshow'],function (require) {
    ...
    (function () {
        var $slideshows = $('[data-slideshow-autoplay]');
        ...
        if ($slideshows.length > 0) {
            ...
            $slideshows.each(function () {
                var $this = $(this),
                    autoplay = ($this.data('slideshow-autoplay') === 'true');
